 ...
 * lightness monotone, adjacent steps >= 0.06 L apart, lightest step still
 * >= 2:1 contrast on paper. Beyond the last defined tier, further tiers reuse
 * the lightest step — color is a secondary cue here, not the only one (the
 * tier number and the tier-start rule carry identity too).
 */
const TIER_FILLS = ["#14191d", "#303941", "#505961", "#6c767e", "#838e96"];
